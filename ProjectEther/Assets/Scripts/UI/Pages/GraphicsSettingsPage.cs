...
namespace OsuVR
{
    ...
    public class GraphicsSettingsPage : SettingsPageBase
    {
        ...
        )
        {
            ...
            antiAliasingDropdown = CreateDropdown(
                parent,
                "Anti-Aliasing",
                "ui_anti_aliasing",
                aaOptions,
            ...
            particleDensitySlider = CreateSlider(
                parent,
                "Particle Density",
                "ui_particle_density",
                0f,
                1f,
                tempSettings.particleDensity,
                PercentFormat,
                v =>
                {
            ...
            renderScaleSlider = CreateSlider(
                parent,
                "Render Scale",
                "ui_render_scale",
                0.5f,
                1f,
                tempSettings.renderScale,
                PercentFormat,
                v =>
                {
            ...
            enableStoryboardPlaybackToggle = CreateToggle(
                parent,
                "Storyboard Playback",
            ...
            storyboardDistanceSlider = CreateSlider(
                parent,
                "Screen Distance",
                "ui_storyboard_distance",
                7.5f,
                15f,
                tempSettings.storyboardScreenDistance,
                "{0:F1}m",
                v =>
                {
            ...
            storyboardAlphaSlider = CreateSlider(
                parent,
                "Screen Opacity",
                "ui_storyboard_alpha",
                0f,
                1f,
                tempSettings.storyboardScreenAlpha,
                PercentFormat,
                v =>
                {
        ...
        public override void RefreshUI(GameSettings tempSettings)
        {
            ...
            if (antiAliasingDropdown != null)
                SetDropdownValueWithoutNotify(
                    antiAliasingDropdown,
                    AaValueToIndex(tempSettings.antiAliasing)
                );
            if (particleDensitySlider != null)
                SetSliderValueWithoutNotify(
                    particleDensitySlider,
            ...
            SetSliderValueWithoutNotify(
                storyboardDistanceSlider,
                tempSettings.storyboardScreenDistance,
                "{0:F1}m"
            );
            SetSliderValueWithoutNotify(
                storyboardAlphaSlider,
                tempSettings.storyboardScreenAlpha,
                PercentFormat,
                100f
            );
