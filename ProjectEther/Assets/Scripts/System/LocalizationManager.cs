    ...
    public static class LocalizationManager
    {
        ...
        private static void InitializeDictionary()
        {
            localizationDict = new Dictionary<string, string[]>
            {
                ...
                {
                    "ui_select_beatmap",
                    new[] { "Select a Beatmap", "选择一首曲目", "ビートマップを選択" }
                },
                ...
                { "ui_credits_section_dev", new[] { "Development", "开发", "開発" } },
                {
                    "ui_credits_section_word",
                    new[] { "A Word from the Developer", "开发者的话", "開発者より" }
                },
                {
                    "ui_credits_word_text",
                    new[]
                    {
                        "This project began with a simple wish: to bring the vast world of osu! beatmaps into VR. May you find your own flow among the waves of sound and light.\n\n— NyaonSaya><",
                        "这个项目始于一个简单的愿望：把 osu! 的海量谱面带进 VR。愿你在音波与光影之间，找到属于自己的心流。\n\n— NyaonSaya><",
                        "このプロジェクトは、osu! の膨大な譜面の世界を VR に届けたい——ただその小さな願いから始まりました。音と光の波の中で、あなただけのフローを見つけてください。\n\n— NyaonSaya><",
                    }
                },
                {
                    "ui_credits_section_opensource",
                    new[] { "Open Source Acknowledgments", "开源致谢", "オープンソース謝辞" }
                },
                {
                    "ui_credits_section_licenses",
                    new[] { "Open Source Licenses", "开源许可", "オープンソースライセンス" }
                },
                {
                    "ui_credits_section_disclaimer",
                    new[] { "Copyright & Trademarks", "版权与商标", "著作権と商標" }
                },
                ...
                {
                    "mod_doubletime_desc",
                    new[] { "Speed up to 150%", "加速至 150%", "150%に加速" }
                },
                ...
                {
                    "mod_hidden_desc",
                    new[] { "Notes fade out gradually", "音符逐渐消失", "ノーツが徐々に消える" }
                },
                { "mod_flashlight_name", new[] { "Flashlight", "手电筒", "フラッシュライト" } },
                {
                    "mod_flashlight_desc",
                    new[] { "Restricted visibility area", "有限的可见区域", "視界が制限される" }
                },
                ...
                {
                    "ui_enable_storyboard",
                    new[] { "Background Screen", "背景板", "背景スクリーン" }
                },
                {
                    "ui_enable_storyboard_playback",
                    new[] { "Storyboard Playback", "故事板", "ストーリーボード" }
                },
                {
                    "ui_storyboard_distance",
                    new[] { "Screen Distance", "屏幕距离", "スクリーン距離" }
                },
                {
                    "ui_storyboard_alpha",
                    new[] { "Screen Opacity", "屏幕不透明度", "スクリーン不透明度" }
                },
                {
                    "ui_select_song_prompt",
                    new[]
                    {
                ...
                {
                    "ui_import_osz",
                    new[] { "Import Beatmap", "导入谱面", "ビートマップをインポート" }
                },
                {
                    "ui_import_success",
                    new[] { "Imported: {0}", "导入成功: {0}", "インポート完了: {0}" }
                },
                {
                    "ui_import_cancelled",
                    new[] { "Import cancelled", "导入已取消", "キャンセルされました" }
                },
                { "ui_import_error", new[] { "Import failed", "导入失败", "インポート失敗" } },
                {
                    ...
                    new[]
                    {
                        "Skipped duplicate beatmap: {0}",
                        "已跳过重复谱面: {0}",
                        "重複ビートマップをスキップ: {0}",
                    }
                },
                {
                    "ui_import_folder_opened",
                    new[]
                    {
                        "Drag .osz files into the opened folder",
                        "请将 .osz 文件拖入已打开的文件夹",
                        "開いたフォルダに.oszファイルをドロップしてください",
                    }
                },
                {
                ...
                {
                    "ui_spinner_bonus_text",
                    new[] { "+{0} Spinner Bonus", "+{0} 转盘奖励", "+{0} スピナーボーナス" }
                },
                {
                    "ui_unknown_artist",
                    new[] { "Unknown Artist", "未知艺术家", "不明なアーティスト" }
                },
                { "ui_unknown_mapper", new[] { "Unknown", "未知", "不明" } },
                { "ui_mapped_by", new[] { "Mapped by {0}", "谱师: {0}", "マッパー: {0}" } },
                { "ui_mods_display", new[] { "Mods: {0}", "Mods: {0}", "モッド: {0}" } },
                {
                    "ui_beatmap_load_failed",
                    new[]
                    {
                        "Beatmap failed to load, returning to menu",
                        "谱面加载失败，返回主菜单",
                        "譜面の読み込みに失敗しました。メニューに戻ります",
                    }
                },
                {
                    "ui_audio_load_failed",
                    new[]
                    {
                        "Audio failed to load, playing without sound",
                        "音频加载失败，将无声游玩",
                        "音声の読み込みに失敗しました。無音でプレイします",
                    }
                },
            };
        }
