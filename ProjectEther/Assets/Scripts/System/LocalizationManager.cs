    ...
    public static class LocalizationManager
    {
        ...
        private static void InitializeDictionary()
        {
            localizationDict = new Dictionary<string, string[]>
            {
                ...
                {"ui_credits_section_word", new[] {"A Word from the Developer", "开发者的话", "開発者より"}},
                {"ui_credits_word_text", new[] {
                ...
                {"ui_credits_section_opensource", new[] {"Open Source Acknowledgments", "开源致谢", "オープンソース謝辞"}},
                {"ui_credits_section_licenses", new[] {"Open Source Licenses", "开源许可", "オープンソースライセンス"}},
                {"ui_credits_section_disclaimer", new[] {"Copyright & Trademarks", "版权与商标", "著作権と商標"}},
                ...
                {"ui_select_song_prompt", new[] {"Please select a song first", "请先选择歌曲", "まず曲を選択してください"}},
                {"ui_import_osz", new[] {"Import Beatmap", "导入谱面", "ビートマップをインポート"}},
