...
public static class StoryboardRenderConformance
{
    ...
    public static string Run()
    {
        if (StoryboardRenderer.Instance != null)
            throw new InvalidOperationException(
                "Run in Edit Mode with no active storyboard renderer."
            );
        ...
        try
        {
            Check(
                ...
                new[]
                {
                    "Sprite,Foreground,Centre,grey.png,320,240",
                    " F,0,0,1000,1",
                    " S,0,0,1000,100",
                },
                true,
                960,
                540,
                new Color(128f / 255, 128f / 255, 128f / 255, 1)
            );
            Check(
                renderer,
                directory,
                ...
                new[]
                {
                    "Sprite,Foreground,Centre,red.png,320,240",
                    " F,0,0,1000,0.5",
                    " S,0,0,1000,100",
                },
                true,
            ...
            Check(
                ...
                new[]
                {
                    ...
                    " S,0,0,1000,100",
                    " P,0,0,1000,A",
                    "Sprite,Foreground,Centre,blue.png,320,240",
                    " F,0,0,1000,0.5",
                    " S,0,0,1000,100",
                },
                true,
            ...
            Check(
                ...
                new[]
                {
                    "Sprite,Pass,Centre,blue.png,320,240",
                    " F,0,0,1000,1",
                    " S,0,0,1000,100",
                    "Sprite,Fail,Centre,red.png,320,240",
                    " F,0,0,1000,1",
                    " S,0,0,1000,100",
                },
                true,
            ...
            Check(
                ...
                new[]
                {
                    ...
                    " F,0,0,1000,1",
                    " S,0,0,1000,100",
                    " C,0,0,1000,0,0,0,255,255,255",
                },
                true,
                960,
                540,
                new Color(0.7353569f, 0.7353569f, 0.7353569f, 1)
            );
            Check(
                renderer,
                directory,
                ...
                new[]
                {
                    "Sprite,Foreground,Centre,red.png,-40,240",
                    " F,0,0,1000,1",
                    " S,0,0,1000,50",
                },
                false,
            ...
            Check(
                ...
                directory,
                results,
                "widescreen original coordinates",
                new[]
                {
                    "Sprite,Foreground,Centre,red.png,-40,240",
                    " F,0,0,1000,1",
            ...
            Check(
                ...
                directory,
                results,
                "clockwise rotation at top-left",
                new[]
                {
                    "Sprite,Foreground,TopLeft,white.png,320,240",
                    " F,0,0,1000,1",
                    " V,0,0,1000,80,40",
                    " R,0,0,1000,1.57079632679",
                },
                true,
                915,
                450,
            ...
            Check(
                ...
                directory,
                results,
                "horizontal flip retains anchor",
                new[]
                {
                    "Sprite,Foreground,TopLeft,pair.png,320,240",
                    " F,0,0,1000,1",
                    " V,0,0,1000,40,40",
                    " P,0,0,1000,H",
                },
            ...
            Check(
                ...
                directory,
                results,
                "negative vector scale flips once",
                new[]
                {
                    "Sprite,Foreground,TopLeft,pair.png,320,240",
                    " F,0,0,1000,1",
            ...
            Check(
                ...
                directory,
                results,
                "flip cancels negative vector scale",
                new[]
                {
                    "Sprite,Foreground,TopLeft,pair.png,320,240",
                    " F,0,0,1000,1",
            ...
            Check(
                ...
                directory,
                results,
                "LoopOnce holds last frame and its dimensions",
                new[]
                {
                    "Animation,Foreground,Centre,frame.png,320,240,3,125,LoopOnce",
                    " F,0,0,1000,1",
                    " S,0,0,1000,50",
                },
                true,
            ...
            Check(
                ...
                directory,
                results,
                "LoopForever advances declared frame sequence",
                new[]
                {
                    "Animation,Foreground,Centre,frame.png,320,240,3,125,LoopForever",
                    " F,0,0,1000,1",
                    " S,0,0,1000,50",
                },
                true,
            ...
            {
                many.Add(
                    "Sprite,Foreground,Centre," + (i == 8192 ? "blue.png" : "red.png") + ",320,240"
                );
            ...
            AssertPixel(
                renderer.GetRenderTexture(),
                960,
                540,
                new Color(0.5f, 0, 0.5f, 1),
                "background blends before scene conversion"
            );
            ...
            AssertPixel(
                ...
                "additive clamps with backdrop before later alpha"
            );
    ...
    public static string CaptureAndCompare(
        string inputPath,
    ...
    {
        if (StoryboardRenderer.Instance != null)
            throw new InvalidOperationException("Capture requires an idle Edit Mode editor.");
        ...
        {
            renderer.LoadStoryboard(
                StoryboardParser.ParseFile(inputPath),
                assetDirectory,
                widescreen
            );
            ...
            if (actual.width != reference.width || actual.height != reference.height)
                throw new Exception("Reference dimensions differ");
            Color32[] a = actual.GetPixels32(),
                b = reference.GetPixels32();
            ...
            for (int i = 0; i < a.Length; i++)
            {
                ...
                diff[i] = new Color32(
                    (byte)Math.Min(255, dr * 8),
                    (byte)Math.Min(255, dg * 8),
                    (byte)Math.Min(255, db * 8),
                    255
                );
            }
            ...
            string report =
                ...
                + maximum
                + "; meanChannelDelta="
                + (total / (double)(a.Length * 3)).ToString(
                    "G8",
    ...
    )
    {
        ...
        try
        {
            ...
            File.WriteAllBytes(
                Path.Combine(directory, name.Replace(' ', '-').Replace(':', '-') + ".png"),
                frame.EncodeToPNG()
            );
    ...
    static void AssertPixel(RenderTexture rt, int x, int y, Color expected, string name)
    {
        ...
        try
        {
            AssertNear(image.GetPixel(x, y), expected, name);
        }
        finally
        {
