...
* **[OsuParsers](https://github.com/Jerry1344/OsuParsers)**: Lightweight .osu/.osb file format parsing library. Its clear decoder architecture and data model design provided important cross-reference for our beatmap parser completion and validation.
